...
then
	...
	printf "\n${YCV}Current specials list:${NCV} wordpress_fpm, bitrix_fpm, opencart_fpm, moodle_fpm, webassyst_fpm\n"
...
do
	...
	# $limit_dirindex_var
	if [[ $proxy_target = "opencart_fpm" ]] || [[ $proxy_target = "wordpress_fpm" ]] || [[ $proxy_target = "bitrix_fpm" ]] || [[ $proxy_target = "moodle_fpm" ]] || [[ $proxy_target = "webassyst_fpm" ]]
	then
