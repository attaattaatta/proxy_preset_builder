...
do
	...
	# $limit_dirindex_var
	if [[ $proxy_target = "opencart_fpm" ]] || [[ $proxy_target = "wordpress_fpm" ]] || [[ $proxy_target = "bitrix_fpm" ]] || [[ $proxy_target = "moodle_fpm" ]]
	then
